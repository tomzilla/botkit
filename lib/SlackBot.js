...
function Slackbot(configuration) {
    ...
    slack_botkit.createOauthEndpoints = function(webserver, callback) {
        ...
        webserver.get('/oauth', function(req, res, next) {
                                ...
                                slack_botkit.saveTeam(team, function(err, id) {
                                    if (err) {
                                        ...
                                        slack_botkit.storage.users.get(identity.user_id, function(err, user) {
                                            ...
                                            slack_botkit.storage.users.save(user, function(err, savedU) {
                                                ...
                                                if (err) {
                                                    ...
                                                    if (isnew) {
                                                        slack_botkit.trigger('create_user', [bot, savedU]);
                                                    } else {
                                                        slack_botkit.trigger('update_user', [bot, savedU]);
                                                    }
                                                }
                                                next();
                                            });
